---
title: "Druckkalibrierung"
sidebar_position: 5
---

# Druckkalibrierung {/* #print-calibration */}

Die Druckkalibrierung verschiebt den gerenderten Urkundeninhalt um einen kleinen X-/Y-Versatz.
...
Der Versatz wird in Punkten angegeben.

- Ein positiver X-Wert verschiebt den Inhalt nach rechts.
- Ein negativer X-Wert verschiebt den Inhalt nach links.
- Ein positiver Y-Wert verschiebt den Inhalt nach unten.
- Ein negativer Y-Wert verschiebt den Inhalt nach oben.
